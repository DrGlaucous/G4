...
#define USE_SSD1306
  ...
  // rotary encoder pins
   #define encA    ENCODER_A
   #define encB    ENCODER_B
   #define encBtn  ENCODER_BUTTON
...
stringIn<2> strIn; //anything as an input (or we can call nav.doNav(cmd) to get the same effect)
...
void loop() {
  ...
  delay(60);//simulate other tasks delay
