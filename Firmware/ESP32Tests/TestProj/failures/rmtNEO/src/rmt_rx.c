...
#include "esp_log.h"
#include "esp_check.h"
//#include "driver/esp_memory_utils.h"//#include "esp_memory_utils.h" //ALTER
...
esp_err_t rmt_new_rx_channel(const rmt_rx_channel_config_t *config, rmt_channel_handle_t *ret_chan)
{
    ...
    rx_channel->base.hw_mem_base = &RMTMEM_NEO.channels[channel_id + RMT_RX_CHANNEL_OFFSET_IN_GROUP].symbols[0];//ALTER
