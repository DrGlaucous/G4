...
#include "driver/periph_ctrl.h" //#include "esp_hw_support/periph_ctrl.h" ALTER
...
void rmt_release_group_handle(rmt_group_t *group)
{
    ...
    rmt_source_clk_t clk_src = group->clk_src;//rmt_clock_source_t clk_src = group->clk_src;//ALTER
