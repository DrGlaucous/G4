...
esp_err_t rmt_new_rx_channel(const rmt_rx_channel_config_t *config, rmt_channel_handle_t *ret_chan)
{
    ...
    rmt_ll_rx_set_mem_owner(hal->regs, channel_id, RMT_LL_MEM_OWNER_HW); //RMT_LL_MEM_OWNER_HW
    ...
    rx_channel->base.hw_mem_base = &RMTMEM_n.channels[channel_id + RMT_RX_CHANNEL_OFFSET_IN_GROUP].symbols[0];
